...
public class JsPerspectiveFactory implements IPerspectiveFactory {
	...
	public void createInitialLayout(IPageLayout layout) {
		IFolderLayout consoleFolder = layout.createFolder("bottom", IPageLayout.BOTTOM, (float)0.75, layout.getEditorArea());
		consoleFolder.addView(IPageLayout.ID_TASK_LIST);
		
		IFolderLayout navFolder= layout.createFolder("top", IPageLayout.TOP, (float) 0.45, layout.getEditorArea());
